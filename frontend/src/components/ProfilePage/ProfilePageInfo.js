  ...
  return (
    <div className={styles.background}>
      <div className={styles.background2}>
        ...
        />
        <p className={styles.profileid}>친구코드 : {userInfo.user_id}</p>
      </div>
      <div className={styles.background2}>
        <span className={styles.profileid2}>
          {`LV ${userInfo.level} ${userInfo.user_name} 님의 프로필`}
        </span>
